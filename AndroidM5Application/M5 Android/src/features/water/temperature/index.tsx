...
const Temperature = () => {
    ...
    if (temperature_range.max_normal != -1 && temperature_range.min_normal != 1) {
        maxTemperature = temperature_range.max_normal;
        minTemperature = temperature_range.min_normal;
    }
    ...
    useEffect(() => {
        const firebaseConnection = () => {
            ...
            firestore().collection('water_temperature').onSnapshot(data => {
                const dataFetch: any = [];
                data.forEach((item) => {
